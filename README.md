...
You can find implementations of these projects in many other languages by other users in [this repo](https://github.com/thekarangoel/Projects-Solutions) or get some informations from [this link](https://github.com/binbin666/Projects/blob/master/patch_2.md).
